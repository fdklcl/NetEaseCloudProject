...
#define RAW_PICTURE_MAX_NUMBER (qreal)10 //显示最多图片个数
//P1-P10，10个位置，根据需要改动
...
#define P7 (qreal)0.15
#define P8 (qreal)0.15
#define P9 (qreal)0.15
#define P10 (qreal)0.15
...
public:
    ...
    ~PictureWidget();
    void setButtonGroup();  //初始化buttonGroup
